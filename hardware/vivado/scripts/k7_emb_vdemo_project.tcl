start_gui
set version "2013.2"
set project_name "k7_emb_vdemo_${version}"
...
# apply UI file
file copy -force $ui_dir/bd_2d4df3e1.ui $project_dir/$project_name.srcs/sources_1/bd/$bd_name/ui/bd_2d4df3e1.ui
...
#open_run impl_1
#open_bd_design {project/k7_emb_vdemo_2013.2.srcs/sources_1/bd/k7_emb_vdemo/k7_emb_vdemo.bd}
#export_hardware [get_files project/k7_emb_vdemo_2013.2.srcs/sources_1/bd/k7_emb_vdemo/k7_emb_vdemo.bd] [get_runs impl_1] -bitstream
#close_project
#exit
