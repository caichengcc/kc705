...
//   {
	...
	xil_printf("\n\r********************************************************\r\n");
	xil_printf("\n\rC A U T I O N ! ! !\r\n");
	xil_printf("This is destructive test, the SD card need to be formatted \r\n");
	xil_printf("after this test. Take SD content backup before proceed. \r\n\r\n");
