...
src/%.o: ../src/%.c
	...
	mb-gcc -Wall -O2 -c -fmessage-length=0 -D __XMK__ -I../../xilkernel_bsp_0/microblaze_subsystem_microblaze_0/include -mlittle-endian -mcpu=v9.1 -mxl-soft-mul -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
