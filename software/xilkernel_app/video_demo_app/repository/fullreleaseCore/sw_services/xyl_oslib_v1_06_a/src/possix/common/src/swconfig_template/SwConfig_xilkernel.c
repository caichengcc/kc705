...
* 1.01.a DJ   10/10/11 Added kernel and system timer definitions and new
...
/**
 * Kernel timer ID specifically designates HW timer instance which is used
 * for kernel time management functionality (time measure, time interrupt,
*  time delay, etc).
 ...
 * Kernel and system timer IDs must be different!
 * To be exact, Kernel timer ID is allways 0 and System timer ID can be from
 * value 1 to higher.
 */
...
/**
*
* Returns current kernel timer tick count.
*
* @param        None.
*
* @return       Current kernel timer tick count.
*
* @note         None.
*
*****************************************************************************/
...
/**
*
* Performs a kernel time delay in miliseconds.
*
