...
#define PLATFORM_TIMER_BASEADDR XPAR_DUAL_TIMER_COUNTER_BASEADDR //XPAR_XPS_TIMER_0_BASEADDR
#define PLATFORM_TIMER_INTERRUPT_INTR XPAR_INTC_0_TMRCTR_0_VEC_ID //XPAR_XPS_INTC_0_XPS_TIMER_0_INTERRUPT_INTR
